...
var (
	...
	ethPortFlag = flag.Int("ethport", 44303, "Listener port for the devp2p connection")
	...
	testnetFlag  = flag.Bool("testnet", false, "Initializes the faucet with testnet config")
)
